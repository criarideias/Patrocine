...
CREATE TABLE IF NOT EXISTS `filmes` (
  ...
  `banner` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `titulo` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `retrato` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `trailer` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `sinopse` text NOT NULL,
  `elenco` text CHARACTER SET utf8 COLLATE utf8_general_ci,
